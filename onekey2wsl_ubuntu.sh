...
# # 配置host
if grep -q "185.199.110.133 raw.githubusercontent.com" /etc/hosts; then
    echo "OK - File /etc/hosts contains string 185.199.110.133 raw.githubusercontent.com"
else
...
if [ -d "${ZSH_CUSTOM:-$HOME/.oh-my-zsh/custom}/themes/powerlevel10k" ]; then
    echo "OK - Directory ~/.oh-my-zsh/custom/themes/powerlevel10k exists"
else
...
export PATH=\$HOME/.wbin:\$PATH
export PATH=\$PATH:~/.local/bin


alias cdd="cd /mnt/c/Users/huber/Desktop/"
alias proxy="source ~/.wbin/proxy.sh"
proxy set
...
# history-substring-search 插件的热键绑定
...
cat << EOF > ~/.p10k.zsh
# Generated by Powerlevel10k configuration wizard on 2023-04-09 at 17:21 CST.
...
if [ -e ${HOME}/.gitconfig ]; then
  echo "OK - File ~/.gitconfig exists."
else
  touch ~/.gitconfig
fi

if grep -q "user" ${HOME}/.gitconfig; then
    echo "OK - file ~/.gitconfig contains [user]"
else
    git config --global user.name "wan pu"
    git config --global user.email "imwanpu@gmail.com"
fi
